...
from .common import define_Lowry_I_Temp
...
class BinaryReversible1T(ModelBase):
    ...
    def _default_sbml_model(self) -> sbml.ModelDefinition:
        return rev_cpe_lowry_caseI_temp()
...
def rev_cpe_lowry_caseI_temp() -> sbml.ModelDefinition:
    ...
    sbml.create_rule(
        model, "D", "piecewise(S*S - 4*kdAA*u, S*S - 4*kdAA*u >= 0, eps)"
    )
